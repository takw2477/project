...
<div class="container" >
    ...
    <div class="row" style="margin-top: 2%;" >
        ...
        <div class="col-lg-4 col-md-4 col-sm-4" style="text-align: left;">
            ...
            <form method="POST" action="http://localhost/engineerfast/web/index.php?controllers=UserController&views=listuser">
                <div class="row" >
                    <h3>ชือ:</h3>
                </div>
                <div class="row" >
                ...
                <div class="row"style="margin-top: 10px;" >
                    <input class="btn btn-info" style="width: 100%;" type="submit" value="add" name="pass" id="user" >
                </div>
            </form>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4"></div>
